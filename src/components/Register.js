...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!validateTelefone(formData.telefone)) {
      newFieldErrors.telefone = "Telefone deve estar no formato (XX) XXXXX-XXXX";
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-purple-50 dark:bg-gray-900 py-8">
      <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <div className="mt-4 text-center">
          <p className="text-purple-700 dark:text-purple-300">
            Já tem uma conta?{" "}
            <Link to="/login" className="text-purple-600 hover:text-purple-800 dark:text-purple-400 dark:hover:text-purple-300">
              Entrar
            </Link>
          </p>
        </div>
